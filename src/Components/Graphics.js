...
const Graphics = () => {
    ...
    const fetchData = async () => {
        fetch(`http://localhost:8080/reviews/count?overall=5`) 
            .then((res) => res.json()) 
            .then((result) => {setCount(result.count)})
        fetch(`http://localhost:8080/reviews/count?overall=4`) 
            .then((res) => res.json()) 
            .then((result) => {setCountFour(result.count)}) 
        fetch(`http://localhost:8080/reviews/count?overall=3`) 
            .then((res) => res.json()) 
            .then((result) => {setCountThree(result.count)}) 
        fetch(`http://localhost:8080/reviews/count?overall=2`) 
            .then((res) => res.json()) 
            .then((result) => {setCountTwo(result.count)}) 
        fetch(`http://localhost:8080/reviews/count?overall=1`) 
            .then((res) => res.json()) 
            .then((result) => {setCountOne(result.count)})
        fetch(`http://localhost:8080/reviews/count?verified=true`) 
            .then((res) => res.json()) 
            .then((result) => {setCountVerified(result.count)}) 
        fetch(`http://localhost:8080/reviews/count?verified=false`) 
            .then((res) => res.json()) 
            .then((result) => {setCountUnverified(result.count)})
        fetch(`http://localhost:8080/reviews/mode?field=reviewerName`) 
            .then((res) => res.json()) 
            .then((result) => {setNameMode(result); console.log(result)})
        fetch(`http://localhost:8080/reviews/mode?field=asin`) 
            .then((res) => res.json()) 
            .then((result) => {setProductMode(result); console.log(result)})
        fetch(`http://localhost:8080/reviews/mode?field=reviewTime`) 
            .then((res) => res.json()) 
            .then((result) => {setDateMode(result); console.log(result)})
        fetch(`http://localhost:8080/reviews/mode?field=summary`) 
            .then((res) => res.json()) 
